...
$colname_subastaver = "-1";
if (isset($_SESSION['Usuario'])) {
  $colname_subastaver = (get_magic_quotes_gpc()) ? $_SESSION['Usuario'] : addslashes($_SESSION['Usuario']);
}
mysql_select_db($database_best, $best);
$query_subastaver = sprintf("SELECT * FROM subastas INNER JOIN usuarios ON subastas.idUsuarios = usuarios.idUsuarios WHERE usuarios.Usuario = %s ORDER BY subastas.Titulo ASC ", $colname_subastaver);
