...
$MM_restrictGoTo = "system/accesoDenegado.php";
...
if (isset($_GET['idUsuarios'])) {
  $colname_subastaver = (get_magic_quotes_gpc()) ? $_GET['idUsuarios'] : addslashes($_GET['idUsuarios']);
}
mysql_select_db($database_best, $best);
$query_subastaver = sprintf("SELECT * FROM subastas WHERE idUsuarios = %s ORDER BY Titulo ASC", $colname_subastaver);
