						...
						<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                          <table align="center">
                            <tr valign="baseline">
                              ...
                              <textarea type="text" name="Respuesta" value="<?php echo $row_pre['Respuesta']; ?>" size="32"></textarea>
                              <span class="textareaRequiredMsg">Ingrese su respuesta.</span><span class="textareaMaxCharsMsg">Se ha superado el número máximo de caracteres.</span></span></td>
                            </tr>
                            <tr valign="baseline">
