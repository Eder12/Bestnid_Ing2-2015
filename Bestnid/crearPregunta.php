                        ...
                        <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                          <table align="center">
                            <tr valign="baseline">
                              ...
                              <textarea type="text" name="Pregunta" value="" size="32"></textarea>
                              <span class="textareaRequiredMsg">Ingrese su pregunta.</span><span class="textareaMaxCharsMsg">Se ha superado el número máximo de caracteres.</span></span></td>
                            </tr>
                            <tr valign="baseline">
